...
This project demonstrates the deployment of a **Three-Tier Web Application** using **AWS EKS, Docker, Kubernetes, and DevOps best practices**. The goal of this project is to showcase scalable, containerized, and automated infrastructure deployment in a cloud environment.
...
2. **Backend Layer**
   ...
   - Connects frontend with database services
...
- Launch EC2 instance
- Configure IAM roles
- Install required tools (AWS CLI, Kubectl, Docker, Terraform)
...
```bash
git clone https://github.com/Jaisonar/Three-Tier-Application-Deployment-on-AWS-EKS.git
